...
const Navbar = () => {
    ...
    return(
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-[#EB0019] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <Link to='/change-password'>
                                <li>
                                    <div class="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent lg:text-white text-[16px]">Change Password</div>
                                </li>
                            </Link>
                                <li>
        ...
        // <div className="font-poppins">
        //     <div className="h-[88px] w-full bg-[#EB0019]">
        //         <div className="flex relative">
        //             <h1 className="pl-[42px] py-[26px] text-[24px] font-extrabold text-white">My Task</h1>
        //             <div className="flex text-[16px] font-medium text-white ml-[896.5px] gap-[42px] py-[32px] absolute right-0 pr-[43.5px]">
        //                 <Link to='/'><p>My Task</p></Link>
